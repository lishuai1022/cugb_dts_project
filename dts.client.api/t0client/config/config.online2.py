...
DATABASES = {
    'peizi': {
        'host': 'rm-uf6k9hpo9uv3fbd7u.mysql.rds.aliyuncs.com',
        'user': 'rwtrans',
...
#trade_api_url
TRADE_SERVER_DOMAIN = 'http://fapi.am.mszhongrui.com'
TRADE_URL_CONFIG = {
...
HQ_DOMAIN = 'http://sq.mszhongrui.com'

#DingDing机器人token
DINGDING_AMS_TOKEN = 'd76bda6aab1e1088dfff13f0b693d5c0e883e8abb9e90fcead8609473e1ec537'

#交易通道key
AMS_TRAN_KEY = 'dts@oak_2019@AMS-hd_online'

#后端配置
DTS_DOMAIN = 'http://open.dts.mszhongrui.com'